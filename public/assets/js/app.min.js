    ...
    arr.forEach(function (item, index) {
      var obj = {
        ...
        "item": {
          "@type": "Product",
          "name": item.name,
          "image": "https://lettstartdesign.com/assets/images/slider-screenshot/" + item.screenshot,
          "description": item.oneLinerDesc,
          "url": "https://lettstartdesign.com#" + item['id'],
          "offers": {
            "@type": "Offer",
      ...
      if (item.rating > 0 && item.num_downloads > 0) {
        obj["item"]["aggregateRating"] = {
          "@type": "AggregateRating",
          "ratingValue": item.rating ? item.rating : 0,
          "reviewCount": item.num_downloads ? item.num_downloads : 0
        };
      }
      itemList.push(obj);
    });
