    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <div class="h6 modal-title" id="loginModalLabel">Login to Lettstart Design</div>
...
<div class="modal fade auth-modal" id="registerModal" tabindex="-1" aria-labelledby="registerModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content pb-0">
            <div class="modal-header">
                <div class="h6 modal-title" id="registerModalLabel">Register to Lettstart Design</div>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <i class="bx bx-x"></i>
                </button>
            </div>
            ...
            <div class="modal-footer text-center">
                <p class="mb-0">By Register to lettstartdesign.com, You are agree to our <a href="{{ route('terms-and-conditions') }}" class="text-primary">Terms of Use</a> and <a href="{{ route('privacy-policy') }}" class="text-primary">Privacy Policy</a></p>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade auth-modal" id="forgotModal" tabindex="-1" aria-labelledby="forgotModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <div class="h6 modal-title" id="forgotModalLabel">Forgot Password</div>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <i class="bx bx-x"></i>
                </button>
            </div>
...
<div class="modal fade auth-modal" id="resetModal" tabindex="-1" aria-labelledby="resetModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <div class="h6 modal-title" id="resetModalLabel">Reset Password</div>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <i class="bx bx-x"></i>
                </button>
            </div>
