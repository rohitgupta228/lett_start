		...
		<div class="row justify-content-center">
			<div class="col-xl-10 text-center">
				...
				<p class="subtitle">Register your subsidiary record with us and make a one of a kind reference ID. On
					...
					mail with instruction. Visit <a href="https://help.gumroad.com/article/129-gumroad-affiliates"
						target="_blank" class="font-weight-bold text-uppercase">here</a> to get better clarity</p>
			</div>
		</div>
	</div>
</div>
				...
				<div class="col-md-8 col-lg-7 col-xl-6">
					<div class="card border-0 box-shadow">
						<div class="card-body">
							...
							<form id="affiliate-form" novalidate="novalidate" method="POST" action="{{ route('submit.contact.us') }}">
								{{ csrf_field() }}
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<input name="validation-fname" id="fname" type="text" class="form-control" placeholder="First Name *">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											<input name="validation-lname" id="lname" type="text" class="form-control" placeholder="Last Name *">
										</div>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<textarea name="validation-promote" id="promote" cols="4" class="form-control" placeholder="How will you promote us *"></textarea>
								</div>
								<div class="clearfix">
