        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group app-label up">
              <input name="user-name" id="edit-user-name" type="text" class="form-control" disabled>
              <label for="user-name">Username</label>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group app-label up">
              <input name="last_name" id="edit-user-email" type="text" class="form-control" disabled>
