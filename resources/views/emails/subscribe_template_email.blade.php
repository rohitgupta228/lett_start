              ...
              <tbody>
                <tr>
                  <td class="pt-20 pb-20 pr-20 pl-20" align="center"
                    style="background: #2982de;padding-top: 20px;padding-bottom: 20px;padding-right: 30px;padding-left: 30px;">
                ...
                <tr>
                  <td align="middle">
                    <h1
                      style="margin-bottom:15px;line-height: 120%; font-size: 24px; font-family: arial, 'helvetica neue', helvetica, sans-serif; font-style: normal;  text-transform: uppercase; font-weight: bold; color: #333333;">
                      {{ $data['product']->name }}</h1>
                  </td>
                </tr>
                <tr>
                  <td align="center" style="padding-right: 30px; padding-bottom:40px;padding-left: 30px;border-bottom:1px solid #ccc">
                ...
                <tr>
                  <td align="center" class="pt-20 pb-40 border-bottom"
                ...
                width: auto;">
                  ...
                  text-decoration: none;
                  width: auto;
                  text-align: center;"><span style="color: #ffffff !important">Explore All
                          Products</span></a>
                    </span>
                  </td>
                </tr>
